namespace WEEK4
{
    ...
    {
        List<Team> Timbaru1 = new List<Team>();
        string selectplayer = "";
        public Form1()
        {
            Preset preset = new Preset();
            InitializeComponent();
            Timbaru1.Add(preset.TeamMU());
            Timbaru1.Add(preset.TeamBARCA());
            Timbaru1.Add(preset.TeamRM());
            nambahcountry();
        }
        public class Preset
        {
        ...
        private void nambahcountry()
        {
            ...
            foreach (Team timbaru2 in Timbaru1)
            {
        ...
        private void button_addteam_Click(object sender, EventArgs e)
        {
            ...
            if (add == false)
            {
                ...
                Timbaru.teamCountry = txtbox_teamcountry.Text;
                Timbaru.teamName = txtbox_teamname.Text;
                Timbaru.teamCity = txtbox_teamcity.Text;
                Timbaru.players = new List<Players>();
                Timbaru1.Add(Timbaru);
                nambahcountry();
